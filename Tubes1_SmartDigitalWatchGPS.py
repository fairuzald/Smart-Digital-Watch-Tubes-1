...
ui = Tk()
ui.resizable(0,0)
ui.title("Tugas Besar 1 : Digital Watch")
ui.geometry("900x640")
...
start_button_stopwatch.place(x=600,y=240)
...
start_timer_button.place(x=601,y=240)
